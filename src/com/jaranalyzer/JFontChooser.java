...
public class JFontChooser extends JComponent {
	...
	public JList<?> getFontStyleList() {
		if (fontStyleList == null) {
			...
			fontStyleList.setCellRenderer(new DefaultListCellRenderer() {
				private static final long serialVersionUID = -390466824251477694L;
	...
	protected class DialogOKAction extends AbstractAction {
		...
		protected String ACTION_NAME = LanguageManager.getString("font.ok");
	...
	protected class DialogCancelAction extends AbstractAction {
		...
		protected String ACTION_NAME = LanguageManager.getString("font.cancel");
		private JDialog dialog;
	...
	protected JDialog createDialog(Component parent) {
		...
		JDialog dialog = new JDialog(frame, LanguageManager.getString("font.dialog.title"), true);
	...
	protected JPanel getFontFamilyPanel() {
		if (fontNamePanel == null) {
			...
			JLabel label = new JLabel(LanguageManager.getString("font.name"));
	...
	protected JPanel getFontStylePanel() {
		if (fontStylePanel == null) {
			...
			JLabel label = new JLabel(LanguageManager.getString("font.style"));
			label.setHorizontalAlignment(JLabel.LEFT);
			label.setHorizontalTextPosition(JLabel.LEFT);
	...
	protected JPanel getFontSizePanel() {
		if (fontSizePanel == null) {
			...
			JLabel label = new JLabel(LanguageManager.getString("font.size"));
			label.setHorizontalAlignment(JLabel.LEFT);
			label.setHorizontalTextPosition(JLabel.LEFT);
	...
	protected JPanel getSamplePanel() {
		if (samplePanel == null) {
			Border titledBorder = BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), LanguageManager.getString("font.sample"));
